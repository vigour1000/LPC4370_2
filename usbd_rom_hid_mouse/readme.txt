This file contains USB HID Mouse example using USB ROM Drivers.
...
For most OSs, no drivers are needed. If no joystick is available on the board
push button can be used to simulate a right click.
